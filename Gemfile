...
group :development do
  # Pinned to a release tag (immutable — branch pins break every downstream fork the
  ...
  gem "modelrails_ui", git: "https://github.com/dschmura/modelrails_ui.git", tag: "v0.4.0"
