...
<svg viewBox="0 0 600 210" width="100%" role="img" aria-label="Sign up and verify, two screens. Create your account, with Email address and Password fields and a Create account button. An arrow labelled submit leads to Confirm your email, which says a verification link was sent, with Resend link and Continue buttons." fill="none" stroke="currentColor" font-family="ui-sans-serif, system-ui, sans-serif">
  ...
  <text x="40" y="70" font-size="13" font-weight="700" fill="currentColor" stroke="none">Create your account</text>
  ...
  <text x="40" y="134" font-size="10" fill="currentColor" stroke="none" opacity="0.7">Password</text>
  <rect x="40" y="139" width="220" height="19" rx="4" stroke-width="1"/><text x="48" y="152" font-size="10.5" fill="currentColor" stroke="none" opacity="0.45">••••••••••••</text>
  <rect class="text-accent" x="40" y="166" width="220" height="22" rx="6" stroke-width="2.25"/><text class="text-accent" x="150" y="181" text-anchor="middle" font-size="11" font-weight="700" fill="currentColor" stroke="none">Create account</text>
  ...
  <text x="330" y="72" font-size="13" font-weight="700" fill="currentColor" stroke="none">Confirm your email</text>
  <text x="330" y="96" font-size="10.5" fill="currentColor" stroke="none" opacity="0.65">We sent a verification link to</text>
  <text x="330" y="112" font-size="10.5" fill="currentColor" stroke="none" opacity="0.65">jane@acme.com — click to confirm.</text>
  ...
  <rect class="text-accent" x="455" y="128" width="115" height="22" rx="6" stroke-width="2.25"/><text class="text-accent" x="512" y="143" text-anchor="middle" font-size="10.5" font-weight="700" fill="currentColor" stroke="none">Continue</text>
  <path d="M290 109 H308" stroke-width="1.5" marker-end="url(#flowarrow-g1)"/>
</svg>

**Why it's shaped this way**

- **Create your account** — A soft, non-blocking gate: registration sends the user to a "check your email" screen but never blocks them. An existing email is routed to **Sign in** instead — never a duplicate `User`. (The magic-link path is passwordless and collects first/last name instead of a password.)
- **Confirm your email** — The verification link confirms the address **and** signs the user in (`after_authentication_url`), collapsing two steps into one. A persistent, non-blocking banner ("Please confirm your email address.") nudges until verified — so the gate never traps anyone.
...
<svg viewBox="0 0 790 180" width="100%" role="img" aria-label="Inviting teammates, three screens. Invite members, an Email addresses field with a Member role and Send invitations. A dashed arrow labelled sent leads to the invitation email, Jamie invited you to join Acme Co as a Member, with Accept invitation and Decline. An arrow labelled accept leads to Set up your login, with First name and Create password and a Join button." fill="none" stroke="currentColor" font-family="ui-sans-serif, system-ui, sans-serif">
  ...
  <text x="558" y="70" font-size="12" font-weight="700" fill="currentColor" stroke="none">Set up your login</text>
  <text x="558" y="90" font-size="9" fill="currentColor" stroke="none" opacity="0.7">First name</text>
  <rect x="558" y="95" width="192" height="17" rx="4" stroke-width="1"/><text x="565" y="107" font-size="9.5" fill="currentColor" stroke="none" opacity="0.45">Sam Diaz</text>
  <text x="558" y="126" font-size="9" fill="currentColor" stroke="none" opacity="0.7">Create password</text>
  <rect x="558" y="131" width="192" height="15" rx="4" stroke-width="1"/><text x="565" y="142.5" font-size="9.5" fill="currentColor" stroke="none" opacity="0.45">••••••••••••</text>
  <rect class="text-accent" x="558" y="150" width="120" height="14" rx="5" stroke-width="2.25"/><text class="text-accent" x="618" y="160" text-anchor="middle" font-size="9.5" font-weight="700" fill="currentColor" stroke="none">Join Acme Co</text>
...
- **Accept / set up login** — Consume-before-verify with an `EmailMismatch` guard: a leaked link can't be claimed by a different address. Existing users join in one click; a new email sets up a login (one `User`, reused everywhere after).
