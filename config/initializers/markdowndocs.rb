...
Markdowndocs.configure do |config|
  ...
  template_categories = {
    ...
    "Guides" => %w[extending security ui-patterns components accessibility deployment background-jobs troubleshooting forking qa-flows project-tools onboarding clientside]
  }
